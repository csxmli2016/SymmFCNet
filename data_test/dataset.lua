...
--   print('image_count', 
   ...
   local imgAB, flip_flag,location,flagPartsUpdate
   imgAB, flip_flag,location,flagPartsUpdate = self:sampleHookTrain(imgpath)
   return imgAB, imgpath, flip_flag,location,flagPartsUpdate
end
...
function dataset:sample(quantity)
   ...
   local samplePaths = {}
   local locationTable = {}
   local flagPartsUpdateTable = {}
   local flipTabel={}
   for i=1,quantity do
      local class = torch.random(1, #self.classes)
--      print(class)
      local out, imgpath,flip_flag,location,flagPartsUpdate = self:getByClass(class)
      table.insert(dataTable, out)
      table.insert(scalarTable, class)
      table.insert(flipTabel,flip_flag)
      
      table.insert(locationTable,location)
      table.insert(flagPartsUpdateTable,flagPartsUpdate)
...
--   print(table)
   ...
   return data, scalarLabels, samplePaths,flipTabel,locationTable,flagPartsUpdateTable-- filePaths
end
